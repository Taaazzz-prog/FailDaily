...
async function runCompleteAPITests() {
  ...
  const tests = [
    ...
    // Tests fails publics (maintenant protégés)
    { name: '📰 Public Fails', endpoint: '/api/fails/public', method: 'GET', 
      headers: { 'Authorization': `Bearer ${AUTH_TOKEN}` }, 
      expectStatus: 200 
    },
    { name: '📰 Public Fails avec pagination', endpoint: '/api/fails/public?page=1&limit=5', method: 'GET', 
      headers: { 'Authorization': `Bearer ${AUTH_TOKEN}` }, 
      expectStatus: 200 
    },
    ...
    { name: '❌ Create Fail sans auth', endpoint: '/api/fails', method: 'POST', 
      body: { title: 'Test', description: 'Test', category: 'test' },
      expectStatus: 401 
    },
