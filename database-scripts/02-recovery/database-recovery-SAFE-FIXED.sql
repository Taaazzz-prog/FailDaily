-- =========================================
-- SCRIPT DE RÉCUPÉRATION SÉCURISÉ - FailDaily
-- =========================================
-- Ce script reconstitue la base de données FailDaily
-- en évitant les erreurs de suppression de tables inexistantes
-- 
-- ATTENTION : Ce script remplace complètement la base de données
-- Exécuter dans l'ordre dans Supabase SQL Editor

-- =========================================
-- 1. SUPPRIMER TOUTES LES STRUCTURES EXISTANTES (SÉCURISÉ)
-- =========================================

-- Supprimer les triggers SEULEMENT s'ils existent
DO $$
BEGIN
    -- Supprimer les triggers sur les tables qui existent
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'fails' AND table_schema = 'public') THEN
...
-- =========================================
-- 4. CRÉER LA TABLE BADGE_DEFINITIONS COMPLÈTE
-- =========================================
...
-- =========================================
-- 5. CRÉER LA TABLE BADGES COMPLÈTE
-- =========================================
